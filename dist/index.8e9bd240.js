...
var _todoService = require("./src/services/TodoService");
var _todoServiceDefault = parcelHelpers.interopDefault(_todoService);
const todoService = new (0, _todoServiceDefault.default)();
...
window.toggleCompletion = async (id, completed)=>{
...
},{"./src/services/TodoService":"iWZK9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iWZK9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TodoService", ()=>TodoService);
...
class TodoService {
    async createTodo(title, description) {
        const todo = (0, _todo.Todo).create(title, description);
        const response = await (0, _axiosDefault.default).post(BASE_URL, todo);
    ...
    async updateTodo(id, updatedFields) {
        const response = await (0, _axiosDefault.default).patch(`${BASE_URL}/${id}`, updatedFields);
        return response.data;
    }
    async deleteTodo(id) {
        await (0, _axiosDefault.default).delete(`${BASE_URL}/${id}`);
    }
}
exports.default = TodoService;

},{"../models/Todo":"8lnkh","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8lnkh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["9IOHb","1jwFz"], "1jwFz", "parcelRequire9ec0")
